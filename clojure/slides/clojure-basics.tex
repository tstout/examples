...
\frame{
  \frametitle{Origins of Clojure - Steve Russell}
  \begin {columns}
    \begin{column}{.49\textwidth}
      \begin{itemize}
...
\frame{
  \frametitle{Persistent Data Structures - 1986}
  \begin {columns}
    \begin{column}{.49\textwidth}
      \begin{itemize}
      \item James R. Drisco
    ...
    \begin{column}{.49\textwidth}
      ...
      \item Logarithmic access, insertion, and deletion times
      \item $O$(1)
...
% Update - I don't think it is. Remove for now...
% 
\begin{frame}
