...
\frame{
  \frametitle{Communicating Sequential Processes (CSP) 1977}
  \begin {columns}
    \begin{column}{.49\textwidth}
      \begin{itemize}
...
\frame{
  \frametitle{Persistent Data Structures - 1989}
  \begin {columns}
    \begin{column}{.49\textwidth}
      \begin{itemize}
      \item James R. Drisco
...
\begin{frame}
  ...
  \vspace{.5cm}
  Everything is simply (fn/macro-name arg1 arg2 ...) where arguments can
...
A set:
  \begin{minted}[fontsize=\normalsize]{clojure}
    #{19 81}
  \end{minted}
A map of various structures:
\begin{minted}[fontsize=\normalsize]{clojure}
  {:phone-numbers ["977-571-3853" "972-571-7477"]
   :zip-codes [75019 75089 75080]}
  \end{minted}  
...
\frame {
  \frametitle{Source Code For These Slides}
  \href{https://github.com/tstout/examples/blob/fn-hack-club-rm-empties/clojure/slides/clojure-basics.tex}
       {\color {blue}{tstout github}}
  }
